...
<template>
  <SiteShell
    v-bind="$attrs"
    header-home="#/"
    :footer-text="t('wallpaintings.identity.copyright')"
  >
    <template #brand>
      <span class="site-logo">
        <span class="site-logo-org">{{ t('wallpaintings.identity.organisation') }}</span>
        <span class="site-logo-title">{{ t('wallpaintings.identity.title') }}</span>
      </span>
    </template>
    <slot />
  </SiteShell>
