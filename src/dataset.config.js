...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'Wall paintings and frescoes',
  ...
  // one entry for every project id `npm pack @museumwnf/wallpaintings-data`
  // carries in `manifest.projects` (checked 2026-09-19, wallpaintings-data 1.0.9).
  ...
  noticeProjects: [], // borrows nothing from Explore Islamic Art Collections
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/wallpaintings' },
