...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'wallpaintings',
  ...
  home: {
    title: 'wallpaintings.identity.title',
    intro: 'wallpaintings.home.intro',
    cards: [
      {
        title: 'wallpaintings.nav.catalogue',
        description: 'wallpaintings.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'wallpaintings.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'wallpaintings.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'wallpaintings.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'wallpaintings.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'wallpaintings.partnerObjects.emptyPartner',
  //         emptyInstitution: 'wallpaintings.partnerObjects.emptyInstitution',
  //         institutionSummary: 'wallpaintings.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'wallpaintings.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'wallpaintings.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
