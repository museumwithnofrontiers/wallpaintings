...
// `useGalleryData.js` used to be byte-identical local copies of what wallpaintings
...
// legacy project key, no UUID — wallpaintings shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (wallpaintings-data 1.0.11+), an outside
