...
The **Museum With No Frontiers — Wall Paintings and Frescoes** gallery, built from the published
dataset `@museumwnf/wallpaintings-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/wallpaintings-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/wallpaintings/> through the reusable workflows in
